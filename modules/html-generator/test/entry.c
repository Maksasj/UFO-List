...
int main() {
    ...
    GcladosTestSuite gcladosTestSuite0 = gcladosCreateTestSuite("/cygdrive/d/Projects/C/UFO-List/modules/html-generator/test/initDefaultHTMLNode.test.c", gcladosTests0, 1);
    ...
    GcladosTestSuite gcladosTestSuite1 = gcladosCreateTestSuite("/cygdrive/d/Projects/C/UFO-List/modules/html-generator/test/initNode.test.c", gcladosTests1, 2);
    ...
    GcladosTestSuite gcladosTestSuite2 = gcladosCreateTestSuite("/cygdrive/d/Projects/C/UFO-List/modules/html-generator/test/pushChildrenNode.test.c", gcladosTests2, 3);
    ...
    GcladosTestSuite gcladosTestSuite3 = gcladosCreateTestSuite("/cygdrive/d/Projects/C/UFO-List/modules/html-generator/test/pushStringLiteral.test.c", gcladosTests3, 3);
    ...
    GcladosTestSuite gcladosTestSuite4 = gcladosCreateTestSuite("/cygdrive/d/Projects/C/UFO-List/modules/html-generator/test/renderToStream.test.c", gcladosTests4, 3);
