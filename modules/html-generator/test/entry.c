...
int main() {
    ...
    GcladosTestSuite gcladosTestSuite0 = gcladosCreateTestSuite("/cygdrive/c/Git/UFO-List/modules/html-generator/test/initNode.test.c", gcladosTests0, 2);
    ...
    GcladosTestSuite gcladosTestSuite1 = gcladosCreateTestSuite("/cygdrive/c/Git/UFO-List/modules/html-generator/test/pushChildrenNode.test.c", gcladosTests1, 3);
    ...
    GcladosTestSuite gcladosTestSuite2 = gcladosCreateTestSuite("/cygdrive/c/Git/UFO-List/modules/html-generator/test/pushStringLiteral.test.c", gcladosTests2, 3);
