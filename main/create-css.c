...
void createCSS(CSS *css) {
    Style *htmlBodyStyles = malloc(sizeof(Style));
    initStyle(htmlBodyStyles, "html, body");
    addCSSProperty(htmlBodyStyles, "margin", "0");
    pushStyle(css, htmlBodyStyles);
    ...
    initStyle(normalText, ".normal-text");
